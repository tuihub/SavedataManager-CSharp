namespace SavedataConfigManager
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            patternType = new DataGridViewComboBoxColumn();
            pattern = new DataGridViewTextBoxColumn();
            clearDir = new DataGridViewCheckBoxColumn();
            baseDirMode = new DataGridViewComboBoxColumn();
            baseDir = new DataGridViewTextBoxColumn();
            ...
            entryDataGridView.Columns.AddRange(new DataGridViewColumn[] { id, patternType, pattern, clearDir, baseDirMode, baseDir });
            entryDataGridView.Dock = DockStyle.Fill;
            entryDataGridView.Location = new Point(0, 50);
            entryDataGridView.Name = "entryDataGridView";
            entryDataGridView.Size = new Size(1000, 400);
            ...
            // patternType
            // 
            patternType.HeaderText = "PatternType";
            patternType.Items.AddRange(new object[] { "Include", "Exclude" });
            patternType.Name = "patternType";
            // 
            // pattern
            // 
            pattern.AutoSizeMode = DataGridViewAutoSizeColumnMode.ColumnHeader;
            ...
            // clearDir
            // 
            clearDir.AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
            clearDir.HeaderText = "ClearDir";
            clearDir.Name = "clearDir";
            clearDir.Resizable = DataGridViewTriState.True;
            clearDir.Width = 61;
            // 
            // baseDirMode
            // 
            baseDirMode.AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
            baseDirMode.HeaderText = "BaseDirMode";
            baseDirMode.Items.AddRange(new object[] { "GameRoot", "UserDocument", "UserProfile", "Absolute" });
            baseDirMode.Name = "baseDirMode";
            baseDirMode.Width = 94;
            // 
            // baseDir
            // 
            baseDir.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            baseDir.HeaderText = "BaseDir";
            ...
            Name = "MainForm";
            Text = "SaveData Config Manager V2.1";
        ...
        private DataGridViewComboBoxColumn patternType;
        private DataGridViewTextBoxColumn pattern;
        private DataGridViewCheckBoxColumn clearDir;
        private DataGridViewComboBoxColumn baseDirMode;
        private DataGridViewTextBoxColumn baseDir;
    }
}